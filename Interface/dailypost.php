...
<body>
                ...
                <div class="col-12">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Daily Post</li>
                        </ol>
                    </nav>
                </div>
            </div>
    ...
    <div class="archive-post-area">
            <div class="container">
             <?php 
							 $status="";
							$qry="select * from dailypost where dpstatus='Active'";
							...
							while($row=mysql_fetch_array($rs))
							{
								...
								$status.="<div class='col-sm-12 col-md-12 col-lg-12 col-xl-12'>";
									$status.="<a href=''><h5>$row[1]</h5></a>";
									$status.="<p>".substr($row[2],0,500)."<a href='dailypostfullview?id=$row[0]' class='text-info'>...Read More</a></p>";
