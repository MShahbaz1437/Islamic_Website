...
<head>
    ...
    <title>Daily Post Update Delete</title>
                ...
                <div class="col-md-8 col-sm-8 col-lg-8 col-xlg-9">
                    ...
                    <div class="well">
                        <form action="" method="post" id="frm" name="frm" enctype="multipart/form-data">
							<input id="check" name="check" type="hidden"  value="36" />
							<input id="did" name="did" type="hidden"  value="<?PHP echo $urlid;?>
" />
							
							<div class="form-group">
								<label class="control-label mb-1">Name</label><br>
								 <textarea class="textarea" placeholder="Place some text here" id="tname" name="tname" ></textarea>
							</div>
							<div class="form-group">
								<label class="control-label mb-1">Detail</label>
								 <textarea class="textarea" placeholder="Place some text here" id="tdetail" name="tdetail" ></textarea>
							</div>
							...
							<div>
								...
								<button type="button"  name="btn2" id="btn2" class="btn btn-success">Delete</button>
								</center>
							</div>
								<script>CKEDITOR.replace('tname'); CKEDITOR.replace('tdetail');</script>
	...
	$(document).ready(function()
	{
		...
		{
			var Id = $("#did").val();
			$.post("check.php",{check:37, urldata:Id},function(data)
				{
					window.location="dailypostview.php";
					$("#show").html(data);
				});
		});
