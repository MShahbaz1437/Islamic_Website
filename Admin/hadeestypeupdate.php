...
<head>
    ...
    <title>Hadees Type Update</title>
				...
				<div class="row">
					<div class="col-md-8 col-sm-8 col-lg-8 col-xlg-9">
						<div class="well">
							...
							<input type="hidden" class="form-control" value="<?php echo $urldata; ?>" id="htid" name="htid" >

								<input id="check" name="check" type="hidden"  value="10">
								<div class="form-group">
									<label class="control-label mb-1">Book Name</label><br>
									 <input type="text" class="form-control" placeholder="Enter Hadees Book Name" id="thbook" name="thbook" >
								</div>
								<div class="form-group">
									<label class="control-label mb-1">Hadees Detail</label>
									 <textarea class="textarea" placeholder="Place some text here" id="thdetail" name="thdetail" ></textarea>
								</div>
								<div class="form-group">
									<label class="control-label mb-1">Hadees Order</label>
									 <input type="text" class="form-control"  id="thorder" name="thorder" />
								</div>
								<div class="from-group mb-1">
									<label class="control-label ">Status</label>
									<select name="thstatus" id="thstatus" class="form-control">
									...
									<b><div id="show"></div></b>
									<script> CKEDITOR.replace('thdetail');</script>
	...
	$(document).ready(function()
	{
		...
		$.ajax(
		{
			...
			success:function(data)
			{
				...
				$("#thbook").val(jdata[1]);
				$("#thdetail").val(jdata[2]);
				$("#thorder").val(jdata[3]);
				$("#thstatus").val(jdata[4]);
			}
		});
		$("#frm").on('submit',function(e)
		{
			...
			$.ajax(
			{
				...
				success:function(data)
				{
					 window.location="hadeestypeview.php";
					$("#show").html(data);
					$("#thbook").val("");
					$("#thdetail").val("");
					$("#thstatus").val("");
