                ...
                <div class="col-md-8 col-sm-8 col-lg-8 col-xlg-9">
                    ...
                    <div class="well">
                        <form action="" method="post" id="frm" name="frm" enctype="multipart/form-data">
							<input id="check" name="check" type="hidden"  value="82" />
							<input id="mid" name="mid" type="hidden"  value="<?php echo $urlid;?>" />
							
							<div class="form-group">
								<label  class="control-label mb-1">Category Name</label>
								<input type="text"  id="tcname" name="tcname" class="form-control" placeholder="Enter Menu Name">
							</div>
							<div class="form-group">
								<label  class="control-label mb-1">Category Order</label>
								<input type="text"  id="tcorder" name="tcorder" class="form-control" placeholder="Enter  Order">
							</div>
							<div class="from-group mb-1">
									<label class="control-label ">Status</label>
									<select name="tcstatus" id="tqstatus" class="form-control">
		...
		$.ajax(
			{
				url:"check.php",
				method:"POST",
				data:{check:81,urldata:ID},
				success:function(data)
				{
					let jdata = JSON.parse(data);
					$("#tcname").val(jdata[1]);
					$("#tcorder").val(jdata[2]); 
					$("#tcstatus").val(jdata[3]);
				}
			});
			$("#btn2").click(function()
			{
				var ID = $("#mid").val();
				$.post("check.php",{check:83,url:ID},function(data)
					{
