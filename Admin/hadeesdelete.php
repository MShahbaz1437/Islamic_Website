...
<body style="background-color:#eef5f9;">
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="row">	<?php $urldata=$_GET["id"];?>

                <div class="col-md-10 col-sm-10 col-lg-10 col-xlg-10">
                   <form id="" name="" method="" action="">
						<input type="hidden" id="hid" name="hid" value="<?php echo $urldata; ?>">
				   </form>
					<div id="show"></div>
                </div>
            </div>
