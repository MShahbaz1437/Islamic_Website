...
<body style="background-color:#eef5f9;">
                ...
                <div class="col-md-8 col-sm-8 col-lg-8 col-xlg-9">
                    ...
                    <div class="well">
                        <form action="" method="post" id="frm" name="frm" enctype="multipart/form-data">
							<input id="check" name="check" type="hidden"  value="88" />
							<input id="did" name="did" type="hidden"  value="<?php echo $urlid;?>" />
							<div class="form-group">
								<label  class="control-label mb-1">Dua Type</label>
								<select type="text"  id="cattype" name="cattype" class="form-control">
							...
							<div class="form-group">
								<label class="control-label mb-1">Dua Title</label><br>
								 <textarea class="textarea" placeholder="Place some text here" id="dtitle" name="dtitle" ></textarea>
							</div>
							<div class="form-group">
								<label class="control-label mb-1">Dua Detail</label>
								 <textarea class="textarea" placeholder="Place some text here" id="ddetail" name="ddetail" ></textarea>
							</div>
							<div class="form-group">
							...
							<div class="from-group mb-1">
									...
									<select name="dstatus" id="tqstatus" class="form-control">
									<option value="Active">Active</option>
									<option value="Deactive">Deactive</option>
									</select>
							</div><br>
							<div>
								<center><input type="submit" class="btn btn-success" name="btn1" value="Update">
								<input type="submit" class="btn btn-success" name="dltbtn" id="dltbtn" value="Delete"></center>
							</div>
								<script>CKEDITOR.replace('dtitle'); CKEDITOR.replace('ddetail');</script>
						</form>
	...
	$(document).ready(function()
	{
		...
		$.ajax(
			...
			{
				let Id=$("#did").val();
				$.post("check.php",{check:89,url:Id},function(data)
				{
					$("#show").html(data);   
				});
			});
