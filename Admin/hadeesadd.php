                ...
                <div class="col-md-8 col-sm-8 col-lg-8 col-xlg-9">
                    ...
                    <div class="well">
                        <form action="" method="post" id="frm" name="frm" enctype="multipart/form-data">
							...
							<div class="form-group">
								<label  class="control-label mb-1">Hadees Chapter Name</label>
							...
							<div>
								<center><input type="submit" class="btn btn-success" name="btn1" value="Insert"></center>
							</div>
