...
<head>
    ...
    <title>Hadees Chapter Update</title>
...
<body style="background-color:#eef5f9;">
                ...
                <div class="col-md-8 col-sm-8 col-lg-8 col-xlg-9">
                    ...
                    <div class="well">
                        <form action="" method="post" id="frm" name="frm" enctype="multipart/form-data">
							<input id="check" name="check" type="hidden"  value="57" />
							<input id="hcid" name="hcid" type="hidden"  value="<?php echo $urlid?>" />
							<div class="form-group">
								<label  class="control-label mb-1">Chapter Name</label>
								<input type="text"  id="hcname" name="hcname" class="form-control" placeholder="Enter Title Name">
							</div>
							<div class="form-group">
							...
							<div class="from-group mb-1">
									...
									<select name="hcstatus" id="tqstatus" class="form-control">
							...
							<div>
								...
								<input type="submit" class="btn btn-success" name="btn2" id="btn2" value="Delete"></center>
							</div>
	...
	$(document).ready(function()
	{
		...
		$.ajax(
		{
				url:"check.php",
				method:"POST",
				data:{check:56,urldata:id},
				success:function(data)
				{
					let jdata = JSON.parse(data);
					$("#hcname").val(jdata[1]);
					$("#hcstatus").val(jdata[2])
					$("#thcname").val(jdata[3])
				}
		});
		$("#btn2").click(function()
		{
			var dlid = $("#hcid").val();
			$.post("check.php",{check:58,urlvalue:dlid},function(data)
				{
					window.location="hadeeschapterview.php";
					$("#show").html(data);
				});
		});
